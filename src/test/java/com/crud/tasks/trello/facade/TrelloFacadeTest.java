...
class TrelloFacadeTest {
    ...
    void shouldCreateCard() {
        //Given
        TrelloCard trelloCard = new TrelloCard("name", "description", "position", "id");
        TrelloCardDto trelloCardDto = new TrelloCardDto("name", "desc", "position", "id");
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("id", "name", "url","new");
